...
ON LINE OFF GRID
Efter endnu et forår med COVID og i nedlukningens tegn ser vi med blandede følelser ind i den tredje digitale afgangsudstilling. Blandede fordi enhver udstilling om arkitektur, efter min opfattelse, skal opleves, sanses, IRL 1:1, og ikke transmitteres gennem eller bag en skærm. 

Som det vil være alle bekendt har COVID ikke bare disruptet vores måde at arbejde på, umuliggjort adgang til værksteder og de vigtige faglige diskussioner med vejledere og medstuderende på tegnesalene.  Den har også haft konsekvenser for skolen som institution og – mindre vigtigt – for mig som kurator og ansvarlig for formidling af afgangsprojekterne til omverdenen. Når det er sagt har det været en lærerig udfordring at skulle formidle digitale projekter digitalt, fagligt og kunstnerisk. 

Heldigvis, kan man sige, behersker arkitekterne de digitale redskaber, som hele vejen gennem studiet er en integreret og naturlig del af undervisningen. Men, når det digitale medie ikke bliver tryktestet på værkstederne eller i mødet med materialerne risikerer man en vis ensretning i afleveringerne, da det digitale aldrig kan stå alene. For de få der tegner i hånden og de som har en mere eksperimenterende tilgang til repræsentation har omstillingen krævet yderligere nytænkning. På trods af udfordringerne, oplever vi et meget højt niveau i projekterne.

Den tredje af tre 100% digitale udstillinger, On Line Off Grid - som følger efter We Do Architecture (WDA) og Processing Architecture (PA) – fortsætter den grafiske og interaktive idsentitet. I takt med at vi i stigende grad benytter digitale platforme og lever online med algoritmer og overvågning til følge, søger vi samtidig - og meget forståeligt - en større samhørighed med naturen, materialerne og det oprindelige. Dertil kommer at arkitekter normalt udvikler deres sprog i teams, på tegnesalen og ikke mindst på værkstederne, i en konstant vekselvirkning mellem det analoge og det digitale. Titlen refererer således til denne dobbelthed som samtidig afspejles i det sort/hvide grafiske design.
Dobbeltheden kommer endvidere til udtryk i projekterne, som på den ene side indholdsmæssigt og sprogligt reflekterer the posthuman og tidens uundgåelige diskurser: køn, klima og en stillingtagen til kolonitiden, samtidig med at de processeres med sikker, digital empati.  De nye arkitekter er optaget af at skabe løsninger for de sårbare, de handler på vegne af naturen, når de skaber nye kulturelle landskaber og f.x. foreslår en landskabelig strategi for sårede landskaber og gør op med generationsforureningerne på Harboøre Tange. Eller de udfordrer Bindingsværkshusets principper i moderne kontekst, foreslår cirkulær arkitektur In a loop of circularity: Building the future from the elements of the past eller de diskuterer køn og arkitektur i A Feminist Approach to Space. Projekter som A Colonial History Center, A Resilient Biotope, Interaction of Tectonics and Linguistics In Light of Pandemics and Climatic Challenges og Radical Transformations af bymidten vidner om et øget fagligt og politisk engagement som bringer arkitekturen til nye domæner.

Selvom pandemien har ændret vores måde at leve, arbejde og socialisere på i en grad, hvor vi næsten ikke længere kan huske, hvordan livet var ’før,’ står vi i en situation hvor der mere end nogensinde er brug for arkitekter, som er i stand til at tænke anderledes og omstille sig, som tør være mere flydende i deres kompetencer og praksis ift at tænke rum og strukturer som en del af sådan et tankesæt.
Og det kan de nye arkitekter De har evnen til at indlejre følelser og tanker i rum og bygninger, de ved at vi kontinuerligt formes af vores omgivelser, velvidende at arkitekturen kan forandre kulturer og påvirke menneskers velbefindende. Derfor er arkitekter, landskabsarkitekter og byplanlæggere så vanvittig vigtig en brik i løsningen af de mange udfordringer verden står i. 

Så lyt til de nye arkitekters stemme, log on, scroll down, og download de fulde projekter og oplev hvordan fremtidens arkitektur processeres nu og her.
...
STAY ONLINE.
  ...
  "credits": `
    ...
    <strong>Graphics Programming</strong>: Jørgen Skogmo / dearstudio 
